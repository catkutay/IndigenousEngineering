...
export class IndigenousEngineeringApp {
  ...
  appPages: PageInterface[] = [
    { title: 'Nearby', name: 'TabsPage', tabName: 'NearbyPage', index: 0, icon: 'locate' },
    { title: 'Categories', name: 'TabsPage', tabName: 'CategoriesPage', index: 1, icon: 'pricetags' },
  ...
  getGeolocation() {
    this.geolocation.getCurrentPosition().then((position: Geoposition) => {
      this.store.dispatch(this.locationActions.updateLocation(position))
